# Generated by Django 3.0.7 on 2020-06-14 17:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('inbound_price', models.FloatField(blank=True, null=True)),
                ('trip', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='trip_price', to='api.Trip')),
            ],
        ),
    ]
